    ...
    function(t) {
        ...
        // },
         Wolmart.setProgressBar = function(e) {
            ...
            }), 75000000000), Wolmart.$body.on("click", ".btn-iframe", (function(e) {
        ...
        var e = {
            init: function() {
                ...
                Wolmart.call(Wolmart.ratingTooltip, 500), Wolmart.call(Wolmart.setProgressBar(".progress-bar"), 500), this.initVariation(), this.initProductsScrollLoad(".scroll-load"), Wolmart.$body.on("mousedown", ".select-menu", (function(e) {
                    ...
                    })), Wolmart.$body.on("click", ".product:not(.product-select) .btn-cart, .product:not(.product-select) .btn-product, .product-popup .btn-cart, .home .product-single .btn-cart", (function(e) {
                        e.preventDefault();
                        var i = t(this),
